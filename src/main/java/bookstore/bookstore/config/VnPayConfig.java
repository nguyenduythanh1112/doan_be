...
public class VnPayConfig {
    ...
    public static String vnp_Returnurl = "http://localhost:3000/announcepayonline";
    public static String vnp_apiUrl = "https://sandbox.vnpayment.vn/merchant_webapi/merchant.html";

    public static String vnp_TmnCode = "24F3A5FL";
    public static String vnp_HashSecret = "BWNFDYXHVSDLZKRXZYNEHUVQGHFFCIZA";
